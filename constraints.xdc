...
# Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { XTAL_CLK }]; # IO_L13P_T2_MRCC_34  Sch=sysclk
create_clock -add -name xtal_clk_pin -period 10.00 [get_ports XTAL_CLK];
...
#set_property -dict { PACKAGE_PIN B22 IOSTANDARD LVCMOS12 } [get_ports { BTN_ASYNC[c] }]; # IO_L20N_T3_16  Sch=btnc
#set_property -dict { PACKAGE_PIN D22 IOSTANDARD LVCMOS12 } [get_ports { BTN_ASYNC[d] }]; # IO_L22N_T3_16  Sch=btnd
#set_property -dict { PACKAGE_PIN C22 IOSTANDARD LVCMOS12 } [get_ports { BTN_ASYNC[l] }]; # IO_L20P_T3_16  Sch=btnl
#set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS12 } [get_ports { BTN_ASYNC[r] }]; # IO_L6P_T0_16   Sch=btnr
#set_property -dict { PACKAGE_PIN F15 IOSTANDARD LVCMOS12 } [get_ports { BTN_ASYNC[u] }]; # IO_0_16        Sch=btnu

# Reset button (0 = pressed, 1 = not pressed).
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { CPU_RESETN_ASYNC }]; # IO_L12N_T1_MRCC_35 Sch=cpu_resetn

# Switches (0 = down, 1 = up).
#set_property -dict { PACKAGE_PIN E22  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[0] }]; # IO_L22P_T3_16      Sch=sw[0]
#set_property -dict { PACKAGE_PIN F21  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[1] }]; # IO_25_16           Sch=sw[1]
#set_property -dict { PACKAGE_PIN G21  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[2] }]; # IO_L24P_T3_16      Sch=sw[2]
#set_property -dict { PACKAGE_PIN G22  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[3] }]; # IO_L24N_T3_16      Sch=sw[3]
#set_property -dict { PACKAGE_PIN H17  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[4] }]; # IO_L6P_T0_15       Sch=sw[4]
#set_property -dict { PACKAGE_PIN J16  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[5] }]; # IO_0_15            Sch=sw[5]
#set_property -dict { PACKAGE_PIN K13  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[6] }]; # IO_L19P_T3_A22_15  Sch=sw[6]
#set_property -dict { PACKAGE_PIN M17  IOSTANDARD LVCMOS12 } [get_ports { SW_ASYNC[7] }]; # IO_25_15           Sch=sw[7]
